...
class ReservationMailerService
{
    ...
    public function sendConfirmation(Reservation $reservation): void
    {
        ...
        $prixLabel = $evenement->getPrix() > 0 ? number_format($evenement->getPrix(), 2)." DT" : "Gratuit";
        ...
        $body = "<div style='font-family:Arial,sans-serif;max-width:580px;margin:0 auto;'>".
            ...
            "<p style='color:rgba(255,255,255,.8);margin:4px 0 0;font-size:13px;'>Confirmation de reservation</p></div>".
            ...
            "<p>Votre reservation pour <strong>".htmlspecialchars($evenement->getTitre())."</strong> est confirmee !</p>".
            "<table style='width:100%%;border-collapse:collapse;margin:16px 0;font-size:13px;'>".
            "<tr style='background:#f9f5ff;'><td style='padding:9px 14px;color:#6a0dad;font-weight:bold;'>Evenement</td><td style='padding:9px 14px;'>".htmlspecialchars($evenement->getTitre())."</td></tr>".
            "<tr><td style='padding:9px 14px;color:#6a0dad;font-weight:bold;'>Date</td><td style='padding:9px 14px;'>".($evenement->getDateEvenement()?->format("d/m/Y") ?? "—")."</td></tr>".
            ...
            "<tr style='background:#f9f5ff;'><td style='padding:9px 14px;color:#6a0dad;font-weight:bold;'>Ref.</td><td style='padding:9px 14px;'>#".$reservation->getIdReservation()."</td></tr></table>".
            ...
            "Votre billet PDF avec QR code est en piece jointe.<br>Presentez-le a l'entree de l'evenement.</p>".
