...
class AdminUserController extends AbstractController
{
    ...
    #[Route('/{id}/analyze-behavior', name: 'admin_user_analyze_behavior', methods: ['GET'])]
    public function analyzeBehavior(Utilisateurs $user, Request $request, BehaviorAIService $behaviorAI): JsonResponse
    {
        if (!$this->checkAdmin($request)) {
            return new JsonResponse(['error' => 'Unauthorized'], 403);
        }

        $result = $behaviorAI->analyze($user, new \DateTime());
